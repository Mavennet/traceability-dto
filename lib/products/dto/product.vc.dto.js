...
const generalVerifiableCredential_dto_1 = require("../../general/dto/generalVerifiableCredential.dto");
...
__decorate([
    ...
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => generalVerifiableCredential_dto_1.GeneralVerifiableCredentialDTO),
    swagger_1.ApiProperty(),
    __metadata("design:type", generalVerifiableCredential_dto_1.GeneralVerifiableCredentialDTO)
