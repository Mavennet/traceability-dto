...
exports.Organization = exports.OrganizationDTO = void 0;
...
__decorate([
    ...
    class_validator_1.Validate(o => o.type === [constants_1.JSON_TYPE.ORGANIZATION]),
...
__decorate([
    ...
    class_validator_1.IsString(),
    __metadata("design:type", String)
], Organization.prototype, "did", void 0);
__decorate([
    swagger_1.ApiPropertyOptional(),
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => postalAddress_dto_1.PostalAddress),
    __metadata("design:type", postalAddress_dto_1.PostalAddress)
