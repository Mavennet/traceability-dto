...
__decorate([
    ...
    class_validator_1.IsEnum(constants_1.JSON_TYPE),
    class_validator_1.Equals(constants_1.JSON_TYPE.ED25519_SIGNATURE_2018),
...
__decorate([
    swagger_1.ApiProperty(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsEnum(constants_1.PROOF_PURPOSE_TYPE),
    __metadata("design:type", String)
